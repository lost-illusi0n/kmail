...
//import dev.sitar.kmail.smtp.agent.queueId
//import dev.sitar.kmail.smtp.agent.rewrite.transports.SmtpServerSocket
//import dev.sitar.kmail.smtp.agent.rewrite.transports.SmtpServerTransport
...
//)
//
//class SubmissionAgentd(
//    val config: SubmissionConfig,
//    val socket: SmtpServerSocket,
...
//    }
//
//    private suspend fun listen(transport: SmtpServerTransport) {
...
//}
//
//private fun SubmissionAgentd.validateMail(mail: Message): Message {
